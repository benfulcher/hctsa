...
%   DESCRIPTOR  : The descriptor of the RY_histogram, seel alse ENTROPY
%
%   X           : The time series to be analyzed, a row vector
%   DESCRIPTOR  : Where DESCRIPTOR=[LOWERBOUND,UPPERBOUND,NCELL]
%     LOWERBOUND: Lowerbound of the RY_histogram
%     UPPERBOUND: Upperbound of the RY_histogram
%     NCELL     : The number of cells of the RY_histogram       
