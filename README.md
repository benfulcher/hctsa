...
Any feedback is hugely helpful [email](mailto:ben.d.fulcher@gmail.com) and, in particular, any improvements to the code would be _much_ appreciated in the form of [pull requests](https://help.github.com/articles/using-pull-requests/).