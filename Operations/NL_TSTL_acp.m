% NL_TSTL_acp
% 
% Implements the TSTOOL routine acp using a time lag,
% tau, a Theiler window, past, maximum delay, maxdelay,
% maximum embedding dimension, maxdim, and number of reference points,
% Nref.
% 
