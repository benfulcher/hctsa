...
%
% ---NOTES:
% Surrogates are generated by Toolboxes/DVV_Toolbox/DVV_surrogate.m, which
% hctsa patches in-place (real-valued branch only) to fix a real performance
% issue found 2026-08-10: the original always ran the full 1000-iteration
% IAAFT budget for every surrogate (its convergence check essentially never
% triggers -- MSE oscillates rather than converging, a known property of
