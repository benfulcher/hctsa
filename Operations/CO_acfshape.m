...
if Nac>3; % enforce at least four points to fit exponential
...
%     plot(maxr,acf(maxr),'ok');
    ...
    out.fexpabsacf_varres = NaN;
    out.flinlmxacf_a = NaN;
    out.flinlmxacf_b = NaN; % this is important
    out.flinlmxacf_r2 = NaN; % this is more important!
    out.flinlmxacf_adjr2 = NaN;
    out.flinlmxacf_rmse = NaN;
end
