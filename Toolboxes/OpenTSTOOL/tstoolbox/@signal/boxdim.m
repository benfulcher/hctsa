function rs = boxdim(s, bins)

%tstoolbox/@signal/boxdim
%   Syntax:
%     * rs = boxdim(s, bins)
%
%   Input arguments:
...
%
%   Compute the boxcounting (capacity) dimension of a time-delay
%   reconstructed timeseries s for dimensions from 1 to D, where D is the
%   dimension of the input vectors using boxcounting approach. The default
%   number of bins is 100.
%
...
% scale data to be within 0 and 1 (this is not longer necessary)
