% EN_HistParChange
% 
% Compares distributional entropies obtained over different bin numbers, or
% different kernel-smoothed width parameters
% 
% INPUTS:
% y, the input time series
% ksorhist, whether to fit: (i) 'ks', kernel-smoothed distribution
%                           (ii) 'hist', histogram
% 

function out = EN_HistParChange(y,ksorhist)
% Ben Fulcher, 2009
