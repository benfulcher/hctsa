...
% ------------------------------------------------------------------------------
fromDatabase = 0;
save('HCTSA_loc.mat','TimeSeries','Operations','MasterOperations',...
            'TS_DataMat','TS_Quality','TS_CalcTime','fromDatabase','-v7.3');

fprintf(1,'Successfully initialized HCTSA_loc.mat with %u time series, %u master operations, and %u operations\n',...
                        numTS,numMops,numOps);
